...
def buscarArquivo(filepath, arquivoConfiguracao=None):
    ...
    ### substituída pela instrução abaixo, pois sys.argv só está disponível
    ### quando o script é executado por linha de comando
    if not arquivoConfiguracao and len(sys.argv) > 1:
