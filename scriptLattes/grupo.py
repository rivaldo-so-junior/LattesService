...
class Grupo:
    ### Os atributos da classe foram modificados para atributos de instância para
    ### permitir que o scriptLattesService possa re-executar
    ### periodicamente o scriptLattes começando com os atributos vazios.
    # compilador = None
    # listaDeParametros = []
    # listaDeMembros = []
    # listaDeRotulos = []
    ...
    def __init__(self, arquivo):
        ...
        self.listaDeMembros = []
        self.listaDeRotulos = []
        self.listaDeRotulosCores = []
        self.listaDePublicacoesEinternacionalizacao = []

        self.arquivoConfiguracao = None
        self.itemsDesdeOAno = None
        self.itemsAteOAno = None
        self.diretorioCache = None
        self.diretorioDoi = None

        self.matrizArtigoEmPeriodico = None
        self.matrizLivroPublicado = None
        self.matrizCapituloDeLivroPublicado = None
        self.matrizTextoEmJornalDeNoticia = None
        self.matrizTrabalhoCompletoEmCongresso = None
        self.matrizResumoExpandidoEmCongresso = None
        self.matrizResumoEmCongresso = None
        self.matrizArtigoAceito = None
        self.matrizApresentacaoDeTrabalho = None
        self.matrizOutroTipoDeProducaoBibliografica = None
        self.matrizSoftwareComPatente = None
        self.matrizSoftwareSemPatente = None
        self.matrizProdutoTecnologico = None
        self.matrizProcessoOuTecnica = None
        self.matrizTrabalhoTecnico = None
        self.matrizOutroTipoDeProducaoTecnica = None
        self.matrizProducaoArtistica = None

        self.matrizPatente = None
        self.matrizProgramaComputador = None
        self.matrizDesenhoIndustrial = None

        self.matrizDeAdjacencia = None
        self.matrizDeFrequencia = None
        self.matrizDeFrequenciaNormalizada = None
        self.vetorDeCoAutoria = None
        self.grafosDeColaboracoes = None
        self.mapaDeGeolocalizacao = None
        self.geradorDeXml = None

        self.vectorRank = None
        self.nomes = None
        self.rotulos = None
        self.geolocalizacoes = None

        self.qualis = None
        self.colaboradores_endogenos = None
        self.listaDeColaboracoes = None

        self.dicionarioDeGeolocalizacao = dict([])
    ...
    def compilarListasDeItems(self):
        ...
        # Grafos de coautoria
######
# Trecho comentado para otimizar o processamento, já que esses dados não são utilizados pelo scriptLattesService
